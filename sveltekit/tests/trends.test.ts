...
test.describe('Trends', () => {
	...
	test('Balance type performances are calculated correctly', async ({ page, baseURL }) => {
		...
		await expect(page.locator('.table__tr:nth-child(1) .table__td:nth-child(2)', { hasText: "+9.9%" })).toBeVisible(); // prettier-ignore
		...
		await expect(page.locator('.tableValue--numeric', { hasText: "-76.9%" })).not.toBeVisible(); // prettier-ignore
		...
		await expect(page.locator('.table__tr:nth-child(5) .table__td:nth-child(9)', { hasText: "5.76%" })).toBeVisible(); // prettier-ignore

		await page.locator('button', { hasText: 'Allocation' }).click();
		await expect(page.locator('.table__tr:nth-child(1) .table__td:nth-child(9)', { hasText: "5.76%" })).toBeVisible(); // prettier-ignore
