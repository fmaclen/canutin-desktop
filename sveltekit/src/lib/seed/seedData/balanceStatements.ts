...
export const accountAutoLoanBalanceStatements = [
	...
	{
		createdAt: subMonths(new Date(), 16),
		value: -42000
	},
	{
		createdAt: subMonths(new Date(), 17),
		value: -42500
	}
];
...
export const accountRothIraBalanceStatements = [
	...
	{
		createdAt: subMonths(new Date(), 19),
		value: 13535.98
	},
	{
		createdAt: subMonths(new Date(), 21),
		value: 13035.75
	},
	{
		createdAt: subMonths(new Date(), 23),
		value: 12535.45
	},
	{
		createdAt: subMonths(new Date(), 25),
		value: 12035.38
	}
];
